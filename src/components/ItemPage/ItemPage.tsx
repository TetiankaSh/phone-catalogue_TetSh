...
export const ItemPage: React.FC<Props> = ({ categoryName, items }) => {
  ...
  const youMayAlsoLike = items.filter(i => i.id !== itemId).slice(0, 12);
      ...
      <div className={styles.item_page__container}>
        <div className={styles.item_page__path}>
          <NavLink to="/">
            <img
              src={HomeIcon}
              alt="Home page"
              className={styles.item_page__path__icon}
            />
          </NavLink>
          ...
          <img
            src={RightArrow}
            alt="Next"
            className={styles.item_page__path__arrow}
          />
          <NavLink
            to={`/${categoryName}`}
            className={styles.item_page__path__link}
          >
        ...
        <div className={styles.item_page__back} onClick={() => navigate(-1)}>
          <img
            src={BackArrow}
            alt="Back"
            className={styles.item_page__back__icon}
          />
        ...
        <div className={styles.item_page__main_info}>
              ...
              {itemImages.map((img, index) => (
                <div
                  ...
                  className={`${styles.item_page__main_info__images__side__image} ${
                    selectedImageIndex === index
                      ? styles[
                        'item_page__main_info__images__side__image--active'
                      ]
                      : ''
                  }`}
                ...
                >
                  <img
                    ...
                    alt="Thumbnail"
                    className={
                      styles.item_page__main_info__images__side__image__img
                    }
                  />
                </div>
              ))}
          ...
          <div className={styles.item_page__main_info__options}>
            <p className={styles.item_page__main_info__options__text}>
              Available colors
            </p>
            <div className={styles.item_page__main_info__options__colors}>
              {availableColors?.map(color => (
                <div
                  key={color}
                  className={`${styles.item_page__main_info__options__colors__container} ${
                    color === item.color
                      ? styles[
                        'item_page__main_info__options__colors__container--active'
                      ]
                      : ''
                  }`}
                >
                  <button
                    type="button"
                    className={
                      styles.item_page__main_info__options__colors__option
                    }
            ...
            <div className={styles.item_page__main_info__options__capacity}>
              ...
              <div
                className={
                  styles.item_page__main_info__options__capacity__buttons
                }
              >
                  ...
                  <button
                    ...
                    className={`${styles.item_page__main_info__options__capacity__options} ${
                      capacity === item.capacity
                        ? styles[
                          'item_page__main_info__options__capacity__options--active'
                        ]
                        : ''
                    }`}
            ...
            <div className={styles.item_page__main_info__options__price}>
              <p
                className={
                  styles.item_page__main_info__options__price__main_price
                }
              >
                ${item.priceDiscount}
              </p>
              <p
                className={
                  styles.item_page__main_info__options__price__full_price
                }
              >
                ${item.priceRegular}
              </p>
            ...
            <div className={styles.item_page__main_info__options__buttons}>
              <Buttons productId={String(item.id)} category={''} />
            </div>

            <div className={styles.item_page__main_info__options__description}>
              <div
                className={
                  styles.item_page__main_info__options__description__line
                }
              >
                <p
                  className={
                    styles.item_page__main_info__options__description__line__text
                  }
                >
                  Screen
                </p>
                <p
                  className={
                    styles.item_page__main_info__options__description__line__value
                  }
                >
                  {item.screen}
                </p>
          ...
          <div className={styles.item_page__info__tech_specs}>
            ...
            <div className={styles.item_page__info__tech_specs__container}>
              <div className={styles.item_page__info__tech_specs__line}>
                <p className={styles.item_page__info__tech_specs__line__text}>
                  Screen
                </p>
                <p className={styles.item_page__info__tech_specs__line__value}>
                  {item.screen}
                </p>
              </div>
              <div className={styles.item_page__info__tech_specs__line}>
              ...
              {item.camera && (
                <div className={styles.item_page__info__tech_specs__line}>
                  ...
                  <p
                    className={styles.item_page__info__tech_specs__line__value}
                  >
                    {item.camera}
                  </p>
                </div>
        ...
        <ProductSlider title="You may also like" products={formattedProducts} />
      </div>
    </div>
  );
};
