      ...
      <div className={styles.favorites__top_bar}>
        <div className={styles.favorites__top_bar__path}>
          <img
            src={HomeIcon}
            alt="Home page"
            className={styles.favorites__top_bar__path__icon}
          />
          <img
            src={RightArrow}
            alt="Next"
            className={styles.favorites__top_bar__path__arrow}
          />
              ...
              <div className={styles.favorites__item__container}>
                ...
                >
                  ...
                  <div className={styles.favorites__item__price__container}>
                    <h4
                      className={
                        styles.favorites__item__price__container__main_price
                      }
                    >
                      ${product.price}
                    </h4>
                    <p
                      className={
                        styles.favorites__item__price__container__full_price
                      }
                    >
                      ${product.fullPrice}
                    </p>
                  ...
                  <div className={styles.favorites__item__description}>
                    <p className={styles.favorites__item__description__key}>
                      Screen:
                    </p>
                    <p className={styles.favorites__item__description__value}>
                      {product.screen}
                    </p>
                  </div>
                  <div className={styles.favorites__item__description}>
