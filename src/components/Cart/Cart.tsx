        ...
        <div className={styles.cart__products}>
          <div className={styles.cart__item}>
            {cartItems.map(cartItem => {
              ...
              return (
                <div key={cartItem.id} className={styles.cart__item__container}>
                  <div className={styles.cart__item__container__inner}>
                    ...
                    >
                      <img
                        ...
                        className={styles.cart__item__remove__icon}
                      />
                    </button>
                    ...
                    >
                      <img
                        ...
                        alt="Product image"
                      />
                      <p className={styles.cart__item__info__title}>
                        {product?.name}
                      </p>
                    </NavLink>
                    ...
                    <div className={styles.cart__item__info__buttons}>
                      ...
                      >
                        <img
                          ...
                          className={
                            styles.cart__item__info__buttons__button__icon
                          }
                        />
                      </button>
                      <span
                        className={styles.cart__item__info__buttons__quantity}
                      >
                        {cartItem.quantity}
                      </span>
                      <button
                    ...
                    <p className={styles.cart__item__info__price}>
          ...
          <div className={styles.cart__checkout}>
            <div className={styles.cart__checkout__container}>
              ...
              <p className={styles.cart__checkout__total}>
