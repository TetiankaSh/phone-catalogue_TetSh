      ...
      <div className={styles.products_category__top_bar}>
        <div className={styles.products_category__top_bar__path}>
          <NavLink to="/">
            <img
              src={HomeIcon}
              alt="Home page"
              className={styles.products_category__top_bar__path__icon}
            />
          </NavLink>
          ...
          <img
            src={RightArrow}
            alt="Next"
            className={styles.products_category__top_bar__path__arrow}
          />
          <p className={styles.products_category__top_bar__path__text}>
            {categoryName}
          </p>
        </div>

        <h1 className={styles.products_category__top_bar__title}>{title}</h1>
        <p className={styles.products_category__top_bar__description}>
          {products.length} models
        </p>

        <div className={styles.products_category__top_bar__filter}>
          <div className={styles.products_category__top_bar__filter__sort}>
            <p className={styles.products_category__top_bar__filter__text}>
              Sort by
            </p>
            <select
              name="sort"
        ...
        <div className={styles.products_category__products}>
          {visibleProducts.map(item => (
            <div
              key={item.id}
              className={styles.products_category__products__item}
            >
              <div
                className={styles.products_category__products__item__container}
              >
                <NavLink
                ...
                >
                  ...
                  />
                  <p className={styles.products_category__products__item__name}>
                    {item.name}
                  </p>
                  <div
                    className={
                      styles.products_category__products__item__price__container
                    }
                  >
                    <h4
                      className={
                        styles.products_category__products__item__price__container__main_price
                      }
                    >
                      ${item.priceDiscount}
                    </h4>
                    <p
                      className={
                        styles.products_category__products__item__price__container__full_price
                      }
                    >
                      ${item.priceRegular}
                    </p>
                  ...
                  <div
                    className={
                      styles.products_category__products__item__description
                    }
                  >
                    <p
                      className={
                        styles.products_category__products__item__description__key
                      }
                    >
                      Screen:
                    </p>
                    <p
                      className={
                        styles.products_category__products__item__description__value
                      }
                    >
                      {item.screen}
                    </p>
        ...
        <div className={styles.products_category__bottom_buttons}>
          <div className={styles.products_category__bottom_buttons__navigation}>
            <button
              className={
                styles.products_category__bottom_buttons__navigation__arrow
              }
            ...
            >
              <img
                ...
                className={
                  styles.products_category__bottom_buttons__navigation__img
                }
              />
            </button>
          </div>
          ...
          <div className={styles.products_category__bottom_buttons__navigation}>
            <div
              className={
                styles.products_category__bottom_buttons__navigation__numbers
              }
            >
              {visiblePageNumbers.map(number => (
                <button
                  ...
                  className={`${styles.products_category__bottom_buttons__navigation__number} ${
                    currentPage === number ? styles['is-active'] : ''
                  }`}
                >
                  {number}
                </button>
