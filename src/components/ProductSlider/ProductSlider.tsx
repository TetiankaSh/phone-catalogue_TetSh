          ...
          >
            {isLeftDisabled ? (
              <img
                ...
                className={styles.product_slider__top_bar__buttons__button__img}
              />
            ) : (
              <img
                src={Active_left}
            ...
            <div key={item.id} className={styles.product_slider__item}>
              <div className={styles.product_slider__item__container}>
                <Link
                  ...
                  className={styles.product_slider__link}
                >
                  <img
                    src={item.image}
                    alt="Item Main Image"
                  ...
                  />
                  <p className={styles.product_slider__item__name}>
                    {item.name}
                  </p>
                  <div
                    className={styles.product_slider__item__price__container}
                  >
                    <h4
                      className={
                        styles.product_slider__item__price__container__main_price
                      }
                    >
                      ${item.price}
                    </h4>
                    {item.fullPrice && (
                      <p
                        className={
                          styles.product_slider__item__price__container__full_price
                        }
                      >
                        ${item.fullPrice}
                      </p>
                  ...
                  <div className={styles.product_slider__item__description}>
                    <p
                      className={styles.product_slider__item__description__key}
                    >
                      Screen:
                    </p>
                    <p
                      className={
                        styles.product_slider__item__description__value
                      }
                    >
                      {item.screen}
                    </p>
